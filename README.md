The two python files contain plenty of methods that visualize different aspects of the dataset, like lidar projected in an image, top down view on all 5 radars, etc.
